...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get("/filteredimage", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const filteredPhotoUrl = yield util_1.filterImageFromURL(image_url);
            if (!filteredPhotoUrl) {
                return res.status(400).send("Error filtering image");
            }
            res.addListener("finish", () => {
                console.log(`removing image ${filteredPhotoUrl} ...`);
                fs_1.default.unlink(filteredPhotoUrl, (error) => {
                    if (error)
                        console.log(`error cleaning up image ${filteredPhotoUrl}`);
                    else
                        console.log(`image ${filteredPhotoUrl} removed`);
                });
            });
